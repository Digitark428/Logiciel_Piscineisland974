...
- **Planification durable :** sauvegarde manuelle immédiate ou quotidienne à 21 h dans le fuseau IANA de chaque entreprise ; un répartiteur Vercel quotidien compatible Hobby lance des workflows durables qui patientent sans consommer de ressources jusqu’à l’heure locale cible. Les données personnelles du planning/to-do, secrets portail et identifiants Auth sont explicitement exclus.
