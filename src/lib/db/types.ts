...
export type ServiceStatus = "planned" | "in_progress" | "completed" | "postponed" | "cancelled";
...
export type SeriesRecurrenceKind = "legacy" | "weekly_contract";
...
export interface ServiceSeries {
  ...
  recurrence_kind: SeriesRecurrenceKind;
