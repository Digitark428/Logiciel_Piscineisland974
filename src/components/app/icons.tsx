...
export const ICON_PATHS: Record<string, string[]> = {
  ...
  community: [P("M8 18a4 4 0 0 0 3.8-4.3A5.5 5.5 0 1 1 17 17h-4.2L8 21v-3z"), P("M8.5 8.5h.01M12 8.5h.01M15.5 8.5h.01")],
  sparkles: [P("m12 3-1.2 4.1L7 8.3l3.8 1.2L12 14l1.2-4.5L17 8.3l-3.8-1.2L12 3z"), P("m5 14-.7 2.3L2 17l2.3.7L5 20l.7-2.3L8 17l-2.3-.7L5 14z"), P("m19 14-.8 2.2L16 17l2.2.8L19 20l.8-2.2L22 17l-2.2-.8L19 14z")],
  ...
  upload: [P("M12 16V4"), P("m7 9 5-5 5 5"), P("M5 14v5a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-5")],
