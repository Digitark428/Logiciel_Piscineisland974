...
- Les sauvegardes sont strictement réservées aux administrateurs. Une demande manuelle ou le scheduler horaire après 21 h locale démarre un workflow durable idempotent : collecte paginée, PDF de synthèse, XLSX exhaustif, puis ZIP privé assemblé en streaming avec galerie et documents. L’historique n’a aucune rétention automatique ; téléchargement et suppression passent par des actions serveur contrôlées. Les secrets, données Auth, to-do/planning personnels et tables techniques sont exclus du catalogue.
